  ...
  <div class="navMenuAction">
    <div class="flex navMenuAction__item">
      <div>
        ...
        >
        <IconPlus class="h-4 w-4 mr-2 fill-current text-#ba2025 hover:text-white"/>Ajouter une offre
          de stage</a
        >
      </div>
      <div>
        ...
        >
        <IconPlus class="h-4 w-4 mr-2 fill-current text-#cb902a hover:text-white"/>Ajouter une demande
          de stage</a
        >
      </div>
      <div>
        ...
        >
        <IconPlus class="h-4 w-4 mr-2 fill-current text-#86a8e6 hover:text-white"/> Ajouter une
          entreprise</a
        >
      </div>
      <div>
