        ...
        <div class="flex-auto">
          <div v-if="!isEditOrCreate" class="presentation-title-border">
            <div class="ml-4">
              ...
              <div v-if="enterprise.activitySector" class="text-gray-600 bg-white py-2 px-4 inline text-2xl">
          ...
          <div v-else class="mb-20">
            ...
            <div class="grid grid-cols-12 mb-3">
              ...
              <select class="col-span-9 border border-gray-400 rounded py-3 px-3 text-gray-600 text-2xl leading-tight focus:border-gray-800 hover:border-gray-800" id="activitySector" name="activitySector" v-model="enterprise.activitySector">
                <option v-for="activity in activitiesSector" :key="activity._id" :value="activity">
                  {{ activity.value }}
                </option>
              </select>
      ...
      <div class="bg-white page-padding">
        ...
        <div class="grid grid-cols-12 gap-8">
          ...
          <div class="col-span-12 md:col-span-6 border-l-8 border-l-gray-600 px-4">
            ...
            <div>
              <div v-if="!isEditOrCreate && enterprise.province" class="text-gray-400">
